...
public class RegisterTest {
   ...
   // @InjectMocks
    ...
    @InjectMocks
    private SecurityController registerController;
    ...
    @BeforeEach
    void setUp() {
        validUser = new UserRegisterDTO("jana","roz", "tirar@tirar.com", "1234" );
        usuarioVacio = new UserRegisterDTO("tiras","tirar","tirar@tirar.com","1234");

        invalidUser = new UserRegisterDTO("vicky2","appleido123", "tulindamama.com", "1234");
    ...
    void whenValidInput_thenReturns201() throws Exception {
        ...
        mockMvc.perform(post("/auth/register")
                ...
                .andExpect(jsonPath("$.email").value("tirar@tirar.com"));
    }
    ...
    void registerShouldCreateUserAndAccounts() {
        ...
        // Assert
        verify(userRepository, times(1)).findByEmail("john@example.com").get();
        verify(roleRepository, times(1)).findByName(RoleNameEnum.USER).get();
