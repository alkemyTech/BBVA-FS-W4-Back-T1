...
public class SendUsdTransactionServiceTest {
    ...
    @Test
    public void testSendUsdSuccessfully() {
    ...
    public void testSendMoney_InvalidCurrencyType() {
        ...
        transactionSendMoneyDTO.setOriginIdAccount(1L);
        transactionSendMoneyDTO.setDestinationIdAccount(2L);
        CurrencyType originCurrencyType = CurrencyType.USD;
        CurrencyType destinationCurrencyType = CurrencyType.ARS; // Tipo de moneda diferente
        String userEmail = "test@example.com";
